...
const UI = {
  vi: {
    ...
    mapTitle: 'Bản Đồ & Trải Nghiệm Khám Phá',
    mapSub: 'Khám phá khu di sản số — chọn một không gian để bước vào tour VR 360°.',
  ...
  en: {
    ...
    mapTitle: 'Map & Discovery Experience',
    mapSub: 'Explore the digital heritage zones — choose a space to step into the VR 360° tour.',
